...
<ul>
  ...
  <li><a href="#contact">Contact</a></li>
   ...
   <li ><a onclick="Add_suppliers()" href="#">ADD ADMIN</a></li>
   <li ><a onclick="myFunction()" href="#">DELETE ADMIN</a></li>
...
<br>
<div class="messages"><?php require_once 'messages.php'; ?></div>
<br>
<?php
...
try {
    ...
    $stmt = $conn->prepare("SELECT username, email, password1 ,contactnumber,address FROM user WHERE role ='admin'");
    $stmt->execute();
...
<div id="Add_suppliers">
    ...
    <img src="images/user.png" class="user">
        ...
        <form name="myform2" action="_admin.php" method="POST" enctype="multipart/form-data">
            ...
            <p for="drivelink">Profile Photo</p>
